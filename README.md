...
北京有这么一家科技有限公司（以下简称「我们」）非常重视您的个人信息，并让您对个人信息拥有控制权，我们会制定严格的政策来管理所有数据。当您访问 本产品 时，或使用我们提供的服务前，您需要同意本政策中关于我们如何收集、使用、储存和分享您的相关信息的规定。如果您不同意本隐私政策中的任何内容，请立即停止使用或访问我们的产品和服务。若您对本政策有任何问题，请联系： compony@suchone.cn

关于我们

本产品的运营者为北京有这么一家科技有限公司。

注册地址为北京市昌平区回龙观西大街9号院3号楼16层1921。
...
1.1.3 通过用户名和密码进入本产品时，需要先注册您的用户名和密码，注册时可能需要您填写您的安全问题，用来后期找回密码和保护您账号的安全。
...
请您注意，目前本产品不会主动从本产品外的第三方获取您的个人信息。如未来为业务发展需要从第三方间接获取您个人信息，我们会在获取前向您明示您个人信息的来源、类型及使用范围，如本产品开展业务需进行的个人信息处理活动超出您原本向第三方提供个人信息时的授权同意范围，我们将在处理您的该等个人信息前，征得您的明示同意；此外，我们也将会严格遵守相关法律法规的规定，并要求第三方保障其提供的信息的合法性。
...
友盟统计
友盟同欣（北京）科技有限公司
系统语言，外部存储状态，最近一次地理位置信息，网络位置信息，网络类型，SIM 卡序列号，网络服务运营商，IMEI，MAC 地址，ANDROID_ID，IP 地址，WiFi 信息，OpenUDID，读取剪切板
用户使用效果统计分析
...
1. 如对本政策内容有任何疑问、意见或建议，您可通过邮件compony@suchone.cn我们联系；

3. 我们还设立了意见、建议反馈邮箱，您可以通过 compony@suchone.cn 与我们联系，我们将在15个工作日内联络您并完成核查和处理。
